...
from app.models.document import FileDocument as Document
from app.models.product import Product

fake = Faker("pt_BR")


async def seed_documents(_session, produtos: list[Product]) -> None:
    """Cria documentos físicos associados aos produtos."""
    ...
    for produto in produtos:
        ...
        for _ in range(num_docs):
            ...
            if extensao == ".pdf":
            ...
            elif extensao == ".jpg" or extensao == ".jpeg":
                ...
                file_content = f"Documento fictício com extensão {extensao}.".encode("utf-8")
            ...
            produto.documents.append(document)
            await produto.save()
    ...
    print(f"  ✓ {total_docs_created} documentos gerados")
